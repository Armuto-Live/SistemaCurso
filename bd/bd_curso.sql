...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-12-2022 a las 17:30:56
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_VERIFICAR_USUARIO` (IN `USUARIO` VARCHAR(100000))  NO SQL SELECT 
usuario.usu_id,
usuario.usu_nombre,
...
FROM
usuario
INNER JOIN rol ON usuario.usu_id=rol.rol_id
...
(2, 'prueba', '$2y$12$MWPfFoqCZShqo3y4E3lEAOdRvkUzB2ZdZwX73.LxBHDlkFL/dVu/G', 'M', 2, 'ACTIVO');
